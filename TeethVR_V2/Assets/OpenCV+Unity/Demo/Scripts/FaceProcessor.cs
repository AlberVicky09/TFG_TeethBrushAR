            ...
            foreach (DetectedFace face in Faces)
            {
                ...
                if (drawSubItems)
                {
                    ...
                    foreach (DetectedObject sub in face.Elements){
                        ...
                        //Send mouth pos
                        if(sub.Name.Equals("OutLip")){
                            //Send mouth center
                            mouthPos = sub.Region.Center;
                        }else if(sub.Name.Equals("InLip")){
                            mouthOpenning = sub.Region.Height;
                        }else if(sub.Name.Equals("LeftEye")){
                            leftEye = sub.Region.Center;
                        }else if(sub.Name.Equals("RightEye")){
                            rightEye = sub.Region.Center;
                        }
                    }
