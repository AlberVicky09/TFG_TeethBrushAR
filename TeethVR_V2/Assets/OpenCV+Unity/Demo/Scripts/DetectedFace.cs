    ...
    class DetectedFace : DetectedObject
    {
        ...
        public void SetLandmarks(Point[] points)
        {
            ...
            if (null != Marks)
            {
                ...
                keysApplied += DefineSubObject(FaceElements.RightEye, "RightEye", 42, 47) ? 1 : 0;

                // non-key but independent
                DefineSubObject(FaceElements.OuterLip, "OutLip", 48, 59);
                DefineSubObject(FaceElements.InnerLip, "InLip", 60, 67);
